...
FirstName = WebUI.waitForElementVisible(findTestObject('QADemo/Modulo Practice Form/input_FirstNameElementAttribute'), 3)
...
LastName = WebUI.waitForElementVisible(findTestObject('QADemo/Modulo Practice Form/input_LastNameElementAttribute'), 3)
